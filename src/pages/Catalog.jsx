...
const Catalog = () => {
  ...
  useEffect(() => {
    ...
    const fetchCategories = async () => {
      try {
        ...
        //getting category id for specific category
  ...
  console.log("catalogPageData.data.Differentcategories.courses-->",catalogPageData.data.Differentcategories.courses)
